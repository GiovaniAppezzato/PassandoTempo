<x-app titulo="Criando postagem - PassandoTempo"
    ...
    <div class="flex flex-col flex-wrap">
        ...
        <div class="flex-grow relative">
                    ...
                    <div class="flex flex-row flex-wrap gap-y-8">
                        ...
                        <div class="w-full md:w-[40%] lg:w-[35%] xl:w-[30%]">
                            ...
                            <div>
                                ...
                                <p class="text-sm">Recomendamos que utilize imagens com a proporção de 16:9 <span class="text-gray-500">(ex: 1280x720, 1920x1080 ... )</span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="min-h-[calc((100vh-60px)-8rem)] hidden" id="" data-wrapper="2">
                ...
                <div class="max-w-[1300px] mx-auto py-4 mb-4 lg:py-6">
                    ...
                    <div class="mx-2 mb-4 p-4 sm:mx-4 lg:mx-6
