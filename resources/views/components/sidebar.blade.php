<div class="hidden lg:block fixed left-0 w-64 xl:w-72 h-[calc(100%-60px)] bg-gray-100 drop-shadow-md z-20 {{ $sidebarLoaded == 'collapse' ? 'sidebar--collapse' : '' }}" id="sidebar"
    ...
    <nav class="h-full overflow-hidden px-4 pt-4">
        <div class="flex justify-between items-center gap-4 mb-4 border-b-2 border-gray-300">
            <label class="p-2 mb-1 rounded cursor-pointer hover:bg-gray-200 active:bg-gray-300">
        ...
        <ul class="overflow-y-auto h-full">
            ...
            <li class="mb-2 select-none">
                <div class="grid grid-cols-[max-content_max-content] items-center gap-2 p-2 rounded cursor-pointer hover:bg-gray-200 active:bg-gray-300" id="usuario" data-sidebar="link-collapse">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="ionicon" viewBox="0 0 512 512"><title>{{ Auth::user() ? Auth::user()->name : 'Usuário' }}</title><path d="M258.9 48C141.92 46.42 46.42 141.92 48 258.9c1.56 112.19 92.91 203.54 205.1 205.1 117 1.6 212.48-93.9 210.88-210.88C462.44 140.91 371.09 49.56 258.9 48zm126.42 327.25a4 4 0 01-6.14-.32 124.27 124.27 0 00-32.35-29.59C321.37 329 289.11 320 256 320s-65.37 9-90.83 25.34a124.24 124.24 0 00-32.35 29.58 4 4 0 01-6.14.32A175.32 175.32 0 0180 259c-1.63-97.31 78.22-178.76 175.57-179S432 158.81 432 256a175.32 175.32 0 01-46.68 119.25z"/><path d="M256 144c-19.72 0-37.55 7.39-50.22 20.82s-19 32-17.57 51.93C191.11 256 221.52 288 256 288s64.83-32 67.79-71.24c1.48-19.74-4.8-38.14-17.68-51.82C293.39 151.44 275.59 144 256 144z"/></svg>
            ...
            {{-- <li class="mb-2 select-none" href="#">
                <a class="grid grid-cols-[max-content_max-content] items-center gap-2 p-2 rounded cursor-pointer hover:bg-gray-200 active:bg-gray-300" id="configuracoes">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="ionicon" viewBox="0 0 512 512"><path d="M427.68 351.43C402 320 383.87 304 383.87 217.35 383.87 138 343.35 109.73 310 96c-4.43-1.82-8.6-6-9.95-10.55C294.2 65.54 277.8 48 256 48s-38.21 17.55-44 37.47c-1.35 4.6-5.52 8.71-9.95 10.53-33.39 13.75-73.87 41.92-73.87 121.35C128.13 304 110 320 84.32 351.43 73.68 364.45 83 384 101.61 384h308.88c18.51 0 27.77-19.61 17.19-32.57zM320 384v16a64 64 0 01-128 0v-16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/></svg>
